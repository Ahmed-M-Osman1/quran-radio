...
$radio_title = $Radio_Languages[$id][0];
}else{
...
if(isset($post->ID)){
	...
	$post_title = $Radio_Languages[$id][0];
}
				...
				<div class="form-wrap">
					<form name="sytform" action="" method="post">
						...
						<div class="form-field">
							<label for="edc_radio_form">Select Language</label>
						...
						<div class="form-field">
							<label for="radio_title">Radio Title</label>
							<input id="radio_title" type="text" name="radio_title" value="<?php echo htmlentities($radio_title); ?>" />
							<p>if empty will write language title.</p>
						</div>

						<div class="form-field">
							<h2>Player Options:</h2>
						<!--
							<p><input id="radio_width" type="text" name="radio_width" value="<?php echo intval($radio_width); ?>" /> Player width.</p>
						-->
							<p><label for="radio_height">Player height</label>
							<input id="radio_height" type="text" name="radio_height" value="<?php echo intval($radio_height); ?>" /></p>
							<p><input id="autostart" type="checkbox" name="check_autostart" <?php echo $check_autostart; ?> /> Autostart</p>
						</div>
						
						<div class="form-field">
							<h2>Show Icons:</h2>
							<p><input id="show_radio_url" type="checkbox" name="show_radio_url" <?php echo $check_show_radio_url; ?> /> Source</p>
							<p><input id="show_radio_pdf" type="checkbox" name="show_radio_pdf" <?php echo $check_show_radio_pdf; ?> /> PDF Book</p>
							<p><input id="show_radio_podcast" type="checkbox" name="show_radio_podcast" <?php echo $check_show_radio_podcast; ?> /> Podcast</p>
							<p><input id="show_radio_alllinks" type="checkbox" name="show_radio_alllinks" <?php echo $check_show_radio_alllinks; ?> /> Download</p>
							<p><input id="show_radio_MediaPlayer" type="checkbox" name="show_radio_MediaPlayer" <?php echo $check_show_radio_MediaPlayer; ?> /> MediaPlayer</p>
							<p><input id="show_radio_QuickTime" type="checkbox" name="show_radio_QuickTime" <?php echo $check_show_radio_QuickTime; ?> /> QuickTime</p>
							<p><input id="show_radio_realplayer" type="checkbox" name="show_radio_realplayer" <?php echo $check_show_radio_realplayer; ?> /> Realplayer</p>
							<p><input id="show_radio_Winamp" type="checkbox" name="show_radio_Winamp" <?php echo $check_show_radio_Winamp; ?> /> Winamp</p>
							<p><input id="show_radio_appstore" type="checkbox" name="show_radio_appstore" <?php echo $check_show_radio_appstore; ?> /> Appstore</p>
							<p><input id="show_radio_android" type="checkbox" name="show_radio_android" <?php echo $check_show_radio_android; ?> /> Android</p>
						</div>
							
						<p class="submit"><input type="submit" name="Submit" id="submit" class="button button-primary" value="Update options"  /></p>
